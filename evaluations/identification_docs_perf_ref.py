...
#langsmith_eval.ls_client.delete_dataset(dataset_id="0c9d22de-d7a9-49f3-826f-135dd8f3e645")
dataset_name = "Identification Questions - Performance"
dataset_description = "Identification prompts about performance"
...
if existing_dataset:
    ...
    queries_top_perf = [
                    "Describe the historical performance of the fund with the best performance in the Asia peer group",
                    "Describe the historical performance of the fund with the best performance in the Growth peer group",
                    "Describe the historical performance of the fund with the best performance in the Hedge Fund peer group",
                    "Describe the historical performance of the fund with the best performance in the India peer group",
                    "Describe the historical performance of the fund with the best performance in the UK Gilts peer group",
    ]

    queries_bottom_perf = ["Describe the historical performance of the fund with the worst performance in the Total Return peer group.",
                    "Describe the historical performance of the fund with the worst performance in the Japan peer group",
                    "Describe the historical performance of the fund with the worst performance in the Income peer group",
                    "Describe the historical performance of the fund with the worst performance in the US Technology peer group",
                    "Describe the historical performance of the fund with the worst performance in the High Yield peer group",
    ...
    for input_query in queries_top_perf:
        ...
        input_data = {"question": top_performer, "top_k":1, "subject": {"text": "performance"}}
        ...
        context_perf = rag_chain.build_perf_context(doc_top_performer, {"text" : "performance"}) # it's a string
...
langsmith_eval.run_evaluation_on_dataset(dataset_name, rag_chain.execute_domain_specific_chain, run_name = "domain_chain_id_perf_10_ref")
langsmith_eval.run_evaluation_on_dataset(dataset_name, rag_chain.execute_agent_executor, run_name = "agent_chain_id_perf_10_ref")